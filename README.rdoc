...
=== The following classes representing BGP messages, attributes, and nlri are defined:
...
Produces:
    ...
    Jean-Michel-Esnaults-MacBook-Pro-17:bgp4r jme$ ruby bin/bgp
...
Build and install a bgp4r gem using Rakefile.
...
Or set RUBYLIB env variable:

(assuming you have cloned copy of bgp4r at /home/user/bgp4r)
